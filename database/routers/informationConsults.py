...
def readKnownsCharacters(character: int):
    ...
    knownIDs = infoConsults.getIDsForKnownCharacter("/Database/Database.db", character)
...
def readAboutName(ID: int):
    ...
    aboutID = infoConsults.getAboutCharacter("/Database/Database.db", ID)
    name = characterConsults.getCharacterName("/Database/Database.db", aboutID)
...
def readKnown(ID: int):
    ...
    knownCharacter = infoConsults.getKnownCharacter("/Database/Database.db", ID)
...
def readAbout(ID: int):
    ...
    # Get the about character
    aboutCharacter = infoConsults.getAboutCharacter("/Database/Database.db", ID)
...
def readDescription(ID: int):
    ...
    # Get the description
    description = infoConsults.getDescription("/Database/Database.db", ID)
